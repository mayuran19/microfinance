...
<div id="body">
	<div class="table-top-caption-left">Showing all configurations</div>
	<br style="clear: both;"/>
	...
	<div id="wrap">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td width="14%" class="tableHeader">Key</td>
			...
			<c:forEach items="${pager.resultSet}" var="model">
				<tr>
					...
					<td class="tableData-left-align">${model.confKey}</td>
					<td class="tableData-left-align">${model.confValue}</td>
					<td class="tableData">
						<a href="<%=request.getContextPath()%>/common/configurations/${model.id}/edit">Edit</a>
					</td>
				</tr>
			</c:forEach>
		</table>
