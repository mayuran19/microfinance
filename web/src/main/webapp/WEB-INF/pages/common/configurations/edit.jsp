...
<div id="body">
	<div class="form-wrapper">
		<div class="form">
			<h5 class="colorBlue">EDIT CONFIGURATION</h5>
			<form:form action="processEdit" method="post" modelAttribute="configuration">
				<!-- print all errors if exists -->
				<spring:hasBindErrors name="configuration">
					<div class="response-msg error">
						<spring:bind path="configuration">
				...
				<table class="form">
					...
					<tr>
						...
						<td>
						<form:input path="value" cssClass="text"/>
						</td>
					</tr>
				</table>
				<p align="center">
