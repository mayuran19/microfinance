...
$(document).ready(
		function() {
		    $('#gnDivision-division-district').change(
		function() {
...
<div id="body">
  <div class="form-wrapper">
    <div class="form-big">
      <h5 class="colorBlue">ADD NEW SOCIETY</h5>
      <form:form action="processAdd" method="post" modelAttribute="society">
