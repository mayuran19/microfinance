...
<div id="body">
	...
	<div class="form-wrapper">
		<div class="form">
			<h5 class="colorBlue">ADDING NEW LOAN PAYMENT FOR ${loan.beneficiary.firstName} ${loan.beneficiary.lastName}</h5>
			<form:form action="processAdd" method="post" modelAttribute="loanPaymentForm">
