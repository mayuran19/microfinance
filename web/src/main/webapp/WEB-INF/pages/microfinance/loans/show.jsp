...
<div id="body">
	<div class="wrap">
		<div class="breadcrumb">
			...
			<a href="<%=request.getContextPath()%>/microfinance/beneficiaries/${beneficiary.id}/loans/${loan.id}">${loan.loanName}</a>
		</div>
	</div>
	...
	<div class="table-top-caption">
		...
		<div class="table-top-caption-right"><a href="<%=request.getContextPath()%>/microfinance/loans/${loan.id}/loanPayments/add">+Add new payment</a></div>
	</div>
	<div class="clear"></div>
	<!-- Loans list -->
	<div id="wrap">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<c:forEach items="${loanPayments}" var="model">
				<tr>
					...
					<td class="tableData">
						<a href="<%=request.getContextPath()%>/microfinance/loans/${loan.id}/loanPayments/${model.id}">View</a>&nbsp;
						<a href="<%=request.getContextPath()%>/microfinance/loans/${loan.id}/loanPayments/${model.id}/edit">Edit</a>
						<a href="<%=request.getContextPath()%>/microfinance/loans/${loan.id}/loanPayments/${model.id}/deactivate" onclick="return confirm('Are you sure you want to delete?')"> Delete</a>
					</td>
				</tr>
			</c:forEach>
		</table>
