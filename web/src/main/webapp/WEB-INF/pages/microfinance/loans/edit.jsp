...
<div id="body">
	<div class="wrap">
		<div class="breadcrumb">
			...
			<a href="<%=request.getContextPath()%>/microfinance/beneficiaries/${beneficiary.id}/loans/${loanForm.id}">${loanForm.loanName}</a> &nbsp;>>&nbsp;
			Add loan
		</div>
	</div>
	<!-- Beneficiary details -->
	...
	<div class="form-wrapper">
		<div class="form">
			<h5 class="colorBlue">EDITING LOAN FOR ${beneficiary.firstName} ${beneficiary.lastName}</h5>
			<form:form action="processEdit" method="post" modelAttribute="loanForm">
