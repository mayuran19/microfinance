  ...
  <div id="wrap">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableBorder">
      <tr>
        ...
        <td class="tableHeader">Deposit type</td>
        <td class="tableHeader">Deposit date</td>
      ...
      <c:forEach items="${pager.resultSet}" var="model">
        <tr>
          ...
          <td class="tableData-left-align">${model.savingAccountDepositType.description}</td>
          <td class="tableData-left-align">${model.depositDate}</td>
          <td class="tableData-left-align">${model.amount}</td>
          <td class="tableData-right-align">${model.remarks}</td>
          <td class="tableData">
          	<a href="<%=request.getContextPath()%>/microfinance/savingAccounts/${savingAccount.id}/savingAccountDeposits/${model.id}/edit">Edit</a>
          </td>
        </tr>
      </c:forEach>
    </table>
