...
<div id="body">
	<div class="form-wrapper">
		<div class="form">
			<h5 class="colorBlue">ADD NEW EXPENSE ACCOUNT</h5>
			<form:form action="processAdd" method="post" modelAttribute="expenseAccount">
				<!-- print all errors if exists -->
				<spring:hasBindErrors name="expenseAccount">
					<div class="response-msg error">
						<spring:bind path="expenseAccount">
