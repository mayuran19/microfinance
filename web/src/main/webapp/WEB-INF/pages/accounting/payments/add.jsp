...
<div id="body">
	<div class="wrap">
		<div class="breadcrumb">
			...
			<a href="<%=request.getContextPath()%>/accounting/expenses/${payment.expense.id}">${payment.expense.invoiceNumber}</a> &nbsp;>>&nbsp; Add payment
		</div>
	</div>
	<div class="form-wrapper">
		<div class="form">
			<h5 class="colorBlue">ADD NEW PAYMENT</h5>
			<form:form action="processAdd" method="post" modelAttribute="payment">
