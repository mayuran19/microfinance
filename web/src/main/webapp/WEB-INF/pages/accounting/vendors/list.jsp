...
<div id="body">
	<div class="table-top-caption-left">Showing all vendors</div>
	<br style="clear: both;"/>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<c:forEach items="${pager.resultSet}" var="model">
				<tr>
					...
					<td class="tableData">
						<a href="<%=request.getContextPath()%>/accounting/vendors/${model.id}">View</a>&nbsp;
						<a href="<%=request.getContextPath()%>/accounting/vendors/${model.id}/edit">Edit</a>
						<a href="<%=request.getContextPath()%>/accounting/vendors/${model.id}/deactivate" onclick="return confirm('Are you sure you want to delete?')"> Delete</a>
					</td>
				</tr>
			</c:forEach>
		</table>
