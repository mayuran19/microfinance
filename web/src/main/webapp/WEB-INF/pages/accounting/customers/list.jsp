...
<div id="body">
	<div class="table-top-caption-left">Showing all customers</div>
	<br style="clear: both;"/>
	...
	<div id="wrap">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td width="14%" class="tableHeader">Address</td>
			...
			<c:forEach items="${pager.resultSet}" var="model">
				<tr>
					...
					<td class="tableData-left-align">${model.customerName}</td>
					<td class="tableData-left-align">${model.address}</td>
					<td class="tableData">
                        <!-- 
						<a href="<%=request.getContextPath()%>/accounting/customers/${model.id}">View</a>&nbsp; -->
						<a href="<%=request.getContextPath()%>/accounting/customers/${model.id}/edit">Edit</a>
					</td>
				</tr>
			</c:forEach>
		</table>
