...
<script type="text/javascript">
	...
	function removeLineItem(lineItemId) {
		...
		$('#incomeDetail_hidden_id_' + lineItemId).remove();
		resetIds();
	}
...
<div id="body">
  <div class="form-wrapper">
    <div class="form-big" style="width: 98%">
      ...
      <form:form action="processEdit" method="post" modelAttribute="incomeForm">
        ...
        <table class="details">
          ...
          <c:forEach items="${incomeForm.incomeDetailForms}" varStatus="i">
            <form:hidden id="incomeDetail_hidden_id_${i.index}" path="incomeDetailForms[${i.index}].incomeId" />
