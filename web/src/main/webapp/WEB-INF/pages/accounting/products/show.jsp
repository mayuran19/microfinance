...
<div id="body">
	...
	<div class="table-top-caption-left">Showing details of <i>${product.name}</i> </div>
	<br style="clear: both;"/>
	<div class="wrap">
		<table class="details">
			<tr>
	...
	<div class="table-top-caption">
		<div class="table-top-caption-left">Product comes under <i>${product.name}</i> product</div>
	</div>
	<div class="clear"></div>
	<div id="wrap">
