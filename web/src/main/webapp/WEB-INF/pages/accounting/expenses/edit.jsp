...
<script type="text/javascript">
	...
	function removeLineItem(lineItemId) {
		...
		$('#expenseDetails_hidden_id_' + lineItemId).remove();
		resetIds();
	}
...
<div id="body">
  <div class="form-wrapper">
    <div class="form-big" style="width: 98%">
      ...
      <form:form action="processEdit" method="post" modelAttribute="expense">
        ...
        <table class="details">
          ...
          <c:forEach items="${expense.expenseDetails}" varStatus="i">
            <form:hidden id="expenseDetails_hidden_id_${i.index}" path="expenseDetails[${i.index}].id" />
